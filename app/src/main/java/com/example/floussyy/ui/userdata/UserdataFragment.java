package com.example.floussyy.ui.userdata;
...
import com.example.floussyy.TraitementUserdata;
...
public class UserdataFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this, new ViewModelProvider.NewInstanceFactory()).get(UserdataViewModel.class);
